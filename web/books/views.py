...
class AuthorListCreateView(ListCreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
        ...
        if name is None or name == '':
            return Response(
                {'detail': 'Поле "name" обязательно для заполнения'}, status=status.HTTP_400_BAD_REQUEST
            )

        author, error_response = AuthorService.create_or_update_author(None, author_data)
...
class GenreListCreateView(ListCreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
        ...
        genre, error_response = GenreService.create_or_update_genre(None, genre_data)
...
class BookListCreateView(ListCreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            return Response(book_serializer.data, status=status.HTTP_201_CREATED, headers=headers)
